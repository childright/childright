...
const ergebnisseDerKlage: NextPage = () => {
  return (
    <StepperLayout>
      <>
        <h1 className="mb-4 text-center">Ergebnisse der Klage (Ratgeber, Infos)</h1>
        <div className="grid grid-cols-2 gap-x-5">
          <div>
            <h4>Dokumente hochladen -> Ergebnis (Der Titel des Gerichts kann in eigene Library hochgeladen werden)</h4>
          </div>
        </div>
