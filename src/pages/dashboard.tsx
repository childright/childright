        ...
        <div className="grid grid-cols-2 gap-x-5">
          ...
          <div>
            ...
            <ul>
              ...
              <li>Profile (eigenes Profil, Mutter, Vater, Geschwisterkinder..)</li>
              <li>“Progress Bar” -> zeigt in welchem Abschnitt man sich befindet (90%)</li>
              <li>zeigen, welche Dokumente noch nachgereicht werden müssen für nächsten Schritten</li>
              <li>Community</li>
              <li>Ratgeber/FAQ </li>
